//
//  SwiftUIView_10.swift
//  swift_ui_pj
//
//  Created by 江培瑋 on 2022/3/3.
//
            ...
            List(restaurant_array.indices){ index in
                ...
                if (0...2).contains(index){
                    ...
                    ZStack(alignment: .leading){
                        ...
                        NavigationLink(destination: restaurant_detail_view(restaurant: restaurant_array[index] )){
...
struct restaurant_detail_view: View{
...
struct SwiftUIView_10_Previews: PreviewProvider {
