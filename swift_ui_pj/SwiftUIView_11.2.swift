    ...
    var body: some View {
        ...
        NavigationView{
            ...
            List(restaurant_array.indices){ index in
                ...
                .fullScreenCover(item: $select_restaurant){ select_restaurant_data in
                    restaurant_detail_view4(restaurant: select_restaurant_data)
                }
...
struct restaurant_detail_view4: View{
...
struct SwiftUIView_11_2_Previews: PreviewProvider {
